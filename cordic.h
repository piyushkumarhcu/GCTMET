...
typedef ap_fixed<32, 20> THETA_TYPE;
typedef ap_fixed<32, 20> COS_SIN_TYPE;
const 	ap_uint<5> NUM_ITERATIONS=10;

static  THETA_TYPE cordic_phase[10]={0.78539816339744828000, 0.46364760900080609000,
									 0.24497866312686414000, 0.12435499454676144000,
									 0.06241880999595735000, 0.03123983343026827700,
									 0.01562372862047683100, 0.00781234106010111110,
